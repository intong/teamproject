...
<body>
	<div id="state">
		...
		<c:choose>
			...
			<c:when test="${test == '주의'}">
		 		<h3 style= "font-size:30px; color:yellow; display:inline-block;">"${test}"</h3>			
			</c:when>
			<c:when test="${test == '건강'}">
	...
	<br><br>
	<div id="chart1">
		 		<h3 style= "font-size:20px; color:blue;">이번 주 나의 BioRhythm!!</h3>				
	</div>
	
	<div id="chart2">
		 		<h3 style= "font-size:20px; color:blue;">이번 달 나의 BioRhythm!!</h3>			
	</div>
